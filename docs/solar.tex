...
\appendix
\chapter{Dokumentacja użytkownika i kod źródłowy}

    \section{Materiały projektowe}
    Kod źródłowy projektu, wraz ze wszystkimi zasobami graficznymi oraz pełną historią zmian, udostępniony został w publicznym repozytorium w serwisie GitHub pod adresem: \url{https://github.com/filipswiszcz/solar}.
    ...
    Aplikacja została zaprojektowana z myślą o środowiskach uniksowych i jest w pełni wspierana na systemach operacyjnych \textbf{macOS} oraz \textbf{Linux}. Do poprawnej kompilacji i uruchomienia programu wymagana jest instalacja następujących pakietów i narzędzi:
        ...
        \begin{itemize}
            ...
            \item \textbf{macOS:}
                \begin{itemize}
                    \item \texttt{Xcode Command Line Tools}
                    \item \texttt{Homebrew} (zalecany do instalacji GLFW: \texttt{brew install glfw})
                \end{itemize}
        \end{itemize}
